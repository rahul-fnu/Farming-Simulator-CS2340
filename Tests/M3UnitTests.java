...
public class M3UnitTests extends ApplicationTest {
    @Override
    ...
    @Test
    public void checkHarvestToInventory() {
    ...
    @Test
    public void checkBuyFromMarket() {
        moveTo("#startGame").clickOn("#startGame");
        clickOn("#nameID");
        write("Jignasa Desai");
        clickOn("#nameSubmit");
